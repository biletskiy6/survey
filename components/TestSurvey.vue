<template>
  <div class="test-survey">
    <div>
      ...
      <div v-if="accessControlType === 'password' && isAccessControlFormVisible" class="password-restriction">
      ...
      <div v-if="accessControlType !== 'password' || accessControlPassword && access" class="survey">
