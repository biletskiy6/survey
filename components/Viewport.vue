        ...
        <div class="pages">
            <perfect-scrollbar class="page-horizontal-scroll" :options="scrollOptions">
                <div class="pages-wrapper">
                    ...
                    >
                        <transition-group class="d-flex ai-fe" type="transition" name="flip-list">
                            <div class="page" :class="{ active: activePageId === page.id }"
                                ...
                                <vs-button color="primary" class="btn-drag" type="flat"
                                           icon="drag_indicator"></vs-button>
                                ...
                                <vs-dropdown>
                                    <vs-button class="btn-drop" color="primary" type="flat"
                    ...
                    <vs-button class="new-page" color="dark" @click="handleAddPage" icon="add" type="filled">New Page
                    </vs-button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$store.commit('widget/resetActiveElement');
