...
<!--                                <vs-button color="primary" class="btn-drag" type="line"-->
<!--                                           icon="drag_indicator"></vs-button>-->

<!--                                <vs-button color="primary" @click.stop="handleCopy(page.id)" type="line"-->
<!--                                           icon="file_copy"></vs-button>-->
<!--                            -->
<!--                            </div>-->
                ...
                <vs-button color="dark" @click="handleAddPage" icon="add" type="filled">New Page</vs-button>
